...
function validarFormulario() {
    ...
    { //Este regex valida que el formato del email sea valido
        ...
        mostrarError(errorEmail, 'Ingrese un correo eléctronico válido')
...
if(!aceptoTerminos.checked){
    ...
    validacionCorrecta = false
} else { ocultarError(errorAceptoTerminos)

}

return validacionCorrecta // Esto dira si el formulario es valido 
